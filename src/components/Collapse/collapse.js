...
// A l'ouverture le Collapse est fermé (valeur par défaut de 'isCollapsed' à 'true').'isCollapsed' est géré par la variable active qui est initialisée par useState.
